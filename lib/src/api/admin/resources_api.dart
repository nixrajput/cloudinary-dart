...
class ResourcesApi {
  ...
  Map<String, dynamic> _listQuery({
    ...
    List<String>? fields,
  }) =>
      {
        ...
        if (moderations != null) 'moderations': moderations,
  ...
  Future<ResourceListResult> list({
    ...
    List<String>? fields,
      ...
      ResourceListResult.fromJson(await _transport.send(
        method: 'GET',
        segments: ['resources', resourceType.name, if (type != null) type],
        query: _listQuery(
  ...
  Future<AssetResource> get(
    ...
    int? maxResults,
      ...
      AssetResource.fromJson(await _transport.send(
        method: 'GET',
  ...
  Future<DeleteResourcesResult> delete(
    ...
    String? nextCursor,
      ...
      DeleteResourcesResult.fromJson(await _transport.send(
        method: 'DELETE',
        segments: ['resources', resourceType.name, type],
        form: {
          'public_ids': publicIds,
          if (invalidate != null) 'invalidate': invalidate,
          if (keepOriginal != null) 'keep_original': keepOriginal,
          if (nextCursor != null) 'next_cursor': nextCursor,
        },
        basicAuth: true,
      ));
  ...
  Future<DeleteResourcesResult> deleteAll({
    ...
    return DeleteResourcesResult.fromJson(await _transport.send(
      method: 'DELETE',
      segments: ['resources', resourceType.name, type],
      form: {
        'all': true,
  ...
  Future<Map<String, dynamic>> deleteDerived(
    List<String> derivedResourceIds,
  ) =>
      _transport.send(
        method: 'DELETE',
