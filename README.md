...
<p align="center">
  <b>92 API methods</b> across Upload, Admin and Search &nbsp;·&nbsp; <b>225 tests</b> &nbsp;·&nbsp; <b>2 runtime dependencies</b> &nbsp;·&nbsp; <b>0 Flutter dependencies</b>
</p>

<p align="center">
  <sub>No benchmark is quoted because an SDK is not a speed story: the work is Cloudinary's, and the only honest numbers here are coverage and correctness. Signing, auth tokens and delivery URLs are pinned by golden vectors derived from Cloudinary's own algorithm.</sub>
</p>
